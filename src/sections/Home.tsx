...
const Home = () => {
  ...
  const slides = [
    {
      image: 'https://images.pexels.com/photos/162568/factory-steel-mill-industry-162568.jpeg',
      title: '專業工廠設備',
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex justify-end">
              <div className="relative w-full max-w-lg">
                {/* 公司風光標題 - 對齊左側主標題 */}
                <h3 className="text-2xl font-bold text-white mb-6 text-center">公司風光</h3>
